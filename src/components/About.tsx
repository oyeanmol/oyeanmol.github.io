...
const stack = [
  ...
  { k: "languages", v: "Python · Javascript · SQL · Salesforce Apex" },
  { k: "Framework", v: "Django · DRF · React/Next JS" },
  { k: "Other", v: "Linux · HTMX · Framer · Tailwind · Git/Github · Docker · Framer" },
];
  ...
  <section id="about" className="py-20">
    ...
    <div className="grid gap-12 md:grid-cols-5">
      <div className="md:col-span-3 space-y-5 text-[15px] leading-relaxed text-muted-foreground">
        <p>
          I'm a backend developer focused on building secure and scalable systems using <span className="text-foreground">Python</span> and <span className="text-foreground">Django</span> who also knows <span className="text-foreground">Salesforce</span>.
        ...
        <p>
          Previously at <span className="text-foreground">Zebpay</span> and
