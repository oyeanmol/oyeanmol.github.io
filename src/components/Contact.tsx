...
const channels = [
  { icon: Mail, label: "anmolshah.work@gmail.com", href: "mailto:anmolshah.work@gmail.com", note: "fastest" },
  { icon: Github, label: "github.com/oyeanmol", href: "https://github.com/oyeanmol", note: "code" },
  { icon: Linkedin, label: "linkedin.com/in/anmolshah1", href: "https://linkedin.com/in/anmolshah1", note: "work" },
  { icon: Twitter, label: "@itsrealas", href: "https://twitter.com/itsrealas", note: "thoughts" },
];
